  ...
  render() {
    return (
      <section className="flex flex-col items-center">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:gap-16 px-4 py-20 gap-5 container lg:max-w-6xl">
          <img
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-slate-700 leading-6 font-light lg:text-xl">
              ...
              aseguramos de estar siempre en contacto con reclutadores para
              saber qué se busca en cada momento. Nuestras plantillas son
              examinadas y corregidas hasta garantizar la perfección.
            </p>
